...
<div class="main-content">
    <section class="section">
        ...
        <div class="section-body">
            ...
            <p class="section-lead">Berikut Merupakan Informasi terkait Pemilik HJ FOOD</p>

            <button class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">Tambah Pemilik</button>
            <div class="row">
                <div class="col-12">
                    <div class="card">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td> <a href="<?= base_url('admin/c_kelola_data/hapus_pemilik/' . $value->id_user) ?>" class="btn btn-icon btn-danger"><i class="fas fa-times"></i></a>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?= base_url('admin/c_kelola_data/simpan_pemilik') ?>" method="POST">
        ...
        <div class="modal fade" tabindex="-1" role="dialog" id="edit<?= $value->id_user ?>">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="<?= base_url('admin/c_kelola_data/edit_pemilik/' . $value->id_user) ?>" method="POST">
                            <div class="form-group">
