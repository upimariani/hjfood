...
<div class="main-content">
    <section class="section">
        ...
        <div class="section-body">
            <h2 class="section-title">Informasi Produk Upselling</h2>
            <p class="section-lead">Berikut Merupakan Informasi terkait Produk Upselling HJ FOOD</p>

            <button class="btn btn-success" data-toggle="modal" data-target="#exampleModal">Tambah Produk Upselling</button>
            <div class="row">
                <div class="col-12">
                    <div class="card">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td> <a href="<?= base_url('admin/c_kelola_data/hapus_upselling/' . $value->id_produk . '/' . $value->id_promo) ?>" class="btn btn-icon btn-danger"><i class="fas fa-times"></i></a>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?php
                    echo form_open_multipart('admin/c_kelola_data/simpan_upselling');
        ...
        <div class="modal fade" tabindex="-1" role="dialog" id="edit<?= $value->id_produk ?>">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <?php
                        echo form_open_multipart('admin/c_kelola_data/edit_upselling/' . $value->id_produk);
